...
const removeBtn = document.getElementById('popup-add-btn');
...
export function moreDetails(popupId) {
  ...
  function details(data) {
    const localid = localStorage.getItem('libraryStorage');
    
    if (localid.includes(data.id)) {
      addbtnListener.classList.add('hidden')
      addbtnListener.id = data.id;
       removebtnListener.id = data.id;
